...
LINGUAS="af cs de en es fa fr hr hu it ko nb pl pt_BR ro ru sk sl sv tr
		 zh_CN zh_TW"
IUSE="+1c doc kerberos kernel_linux ldap libressl nls pam perl -pg_legacytimestamp python
...
src_prepare() {
	...
	if use 1c ; then
		epatch "${FILESDIR}/65-1c_FULL_95-0.23.1.patch" \
		"${FILESDIR}/66-applock-1c-9.4.patch" \
		"${FILESDIR}/67-postgresql-1c-9.5.patch" \
		"${FILESDIR}/68-online_analyze-9.5.patch" \
		"${FILESDIR}/69-plantuner.patch"
